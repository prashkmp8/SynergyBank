...
public class LoansDto {
    ...
    public @Positive(message = "Total loan amount should be greater than zero") int getTotalLoan() {
        return totalLoan;
    }
    ...
    public @PositiveOrZero(message = "Total loan amount paid should be equal or greater than zero") int getAmountPaid() {
        return amountPaid;
    }
    ...
    public @PositiveOrZero(message = "Total outstanding amount should be equal or greater than zero") int getOutstandingAmount() {
    ...
    public LoansDto(int outstandingAmount, int amountPaid, int totalLoan, String loanType, String loanNumber, String mobileNumber) {
        this.outstandingAmount = outstandingAmount;
        this.amountPaid = amountPaid;
        this.totalLoan = totalLoan;
        this.loanType = loanType;
